...
<footer className="footer footer-center p-10 text-white relative">
    <div className="absolute inset-0 bg-black bg-opacity-75" style={{
        backgroundImage: "url('https://i.ibb.co/2ndyyD0/long-narrow-painting-art-exhibition.jpg')",
    ...
    <div className="relative z-10">
        <aside>
            ...
            Artistry Avenue <br/>Providing Reliable Arts 
            </p> 
